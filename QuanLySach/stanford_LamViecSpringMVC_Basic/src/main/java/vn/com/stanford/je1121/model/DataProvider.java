...
public class DataProvider {
    ...
    private static final String DATABASE_LINK = "jdbc:mysql://localhost:3306/je112101hv?useUnicode=true&characterEncoding=UTF-8&useSSL=false&allowPublicKeyRetrieval=true";
    ...
    public static Connection ketNoi() {
        ...
        try {
            ...
            conn = DriverManager.getConnection(DATABASE_LINK, "root", "rinnv");
